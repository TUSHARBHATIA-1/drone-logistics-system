              ...
              <div className="flex-1 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <h3 className="text-lg text-white font-outfit font-bold">{notif.title}</h3>
                ...
                <div className="flex gap-4 pt-3 items-center">
                  {notif.assignment && (
                    <button className="flex items-center gap-2 text-[10px] font-black uppercase text-primary-500 hover:text-primary-400 tracking-tighter transition-colors group/btn">
